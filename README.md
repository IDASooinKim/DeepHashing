...
*This is a PyTorch implementation of a deep hashing algorithm integrated with a __mini-batch-based graph construction__ module. The provided experiments and dataset use [Stanford Cars](https://www.kaggle.com/datasets/eduardo4jesus/stanford-cars-dataset).
...
HAGCN is tested using the benchmark datasets [STL-10](https://cs.stanford.edu/~acoates/stl10/), [Stanford Cars](https://www.kaggle.com/datasets/eduardo4jesus/stanford-cars-dataset), and [Tiny ImageNet](https://www.kaggle.com/c/tiny-imagenet). 
...
# 4. Usage Instructions & Requrements
